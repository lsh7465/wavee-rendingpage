  ...
  return (
    <>
      <img
        src="/logo.svg"
        alt="logo"
        className=" header-fade w-110 m-10 mb-0"
      />
      <VideoBackground>
        <div className="flex flex-col justify-center items-center h-screen">
          <p
            className="font-audiowide text-7xl wavee-text-fade
          ...
          <button
            className="button-scale text-white text-md border rounded-full p-3 px-6 mt-28 opacity-65
